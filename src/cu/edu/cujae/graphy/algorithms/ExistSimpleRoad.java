...
public class ExistSimpleRoad<V> extends AbstractAlgorithm<Pair<Integer, List<Integer>>>
{
    ...
    public ExistSimpleRoad(WeightedGraph<V> graph, GraphIterator<V> iteratorNI, GraphIterator<V> iteratorNF, int k,
                           int pesoMayor)
    {
    ...
    public Algorithm<Pair<Integer, List<Integer>>> apply()
    {
        ...
        for (int l = 0; l <= k; l++)
        {
            for (int i = 0; i < vertices; i++)
            {
                ...
                {
                    GraphIterator<V> iterat = graph.iterator(visitados.get(i));
                    GraphIterator<V> iterat2 = graph.iterator(visitados.get(j));
                    ...
                    if (l == 1 && graph.isVertexAdjacent(label1, label2))
                    {
                        ...
                        Edge edge = iterat.getAdjacentEdge(label2) != null ? iterat.getAdjacentEdge(label2) : iterat2.
                                getAdjacentEdge(label1);
                    ...
                    if (l > 1)
                    {
                        ...
                        {
                            GraphIterator<V> iterat3 = graph.iterator(visitados.get(a));
                            ...
                            if (iterat.isAdjacent(iterat3) && i != a && j != a && trimatrix.get(iterat3.getLabel(),
                                                                                                iterat2.getLabel(), l
                                                                                                                            - 1)
                                                                                  != pesoMayor)
                            {
                                ...
                                trimatrix.put(iterat.getLabel(), iterat2.getLabel(), l, Math.min(trimatrix.get(iterat.
                                              getLabel(), iterat2.getLabel(), l), ((iterat.getAdjacentEdge(
                                                                                    iterat3.getLabel()) != null)
                                                                                   ? (Integer) iterat.getAdjacentEdge(
                                                                                   iterat3.getLabel()).getWeight().
                                                                                   getValue() : (Integer) iterat3.
                                                                                   getAdjacentEdge(iterat.getLabel()).
                                                                                   getWeight().getValue()) + trimatrix.
                                                                                                 get(iterat3.getLabel(),
                                                                                                     iterat2.getLabel(),
                                                                                                     l - 1)));
                            }
                        }
        ...
        setResult(new Pair<>(trimatrix.get(iteratorNI.getLabel(), iteratorNF.getLabel(), k), new LinkedList<>()));
        return this;
    }
