...
public class PrimMinimalTree<T> extends AbstractAlgorithm<WeightedGraph<T>>{
    ...
    public Algorithm<WeightedGraph<T>> apply() {
        GraphIterator<T> iterator = (GraphIterator<T>)graph.iterator(0);
        ...
        for(int i = 0; i < graph.size() - 1; i++){
            ...
            }while(addedNodes.contains(shortestEdge.getStartNode().get()) && addedNodes.contains(shortestEdge.getFinalNode().get()));
