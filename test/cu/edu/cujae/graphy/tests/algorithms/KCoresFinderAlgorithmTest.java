...
import cu.edu.cujae.graphy.algorithms.KCoresFinderAlgorithm;
 ...
 */
public class KCoresFinderAlgorithmTest 
{
    public static void main(String[] args)
    {
      Graph<Integer> g = new DefaultGraphBuilder<Integer>().buildGraph().directed(false).get();
        ...
        System.out.println(new KCoresFinderAlgorithm<>(g,k).apply().get());
    }
}
