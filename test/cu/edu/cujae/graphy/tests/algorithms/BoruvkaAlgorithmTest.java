...
import cu.edu.cujae.graphy.algorithms.BoruvkaMinimalTree;
...
public class BoruvkaAlgorithmTest {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("Boruvka Minimal Spanning Tree Algorithm: ");
        System.out.println(new BoruvkaMinimalTree(graph).apply().get());
    }
