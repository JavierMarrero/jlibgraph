...
public class EulerianCycleDetectionTest
{
    ...
    public static void main(String[] args)
    {
        ...
        System.out.println("El grafo no conexo es un ciclo Euleriano ?: " + (new EulerianCycleDetection<>(graphNoConex).
                                                                             apply().get()));
        ...
        System.out.println("El grafo conexo es un ciclo Euleriano con todos los nodos de grado par?: "
                           + (new EulerianCycleDetection<>(graphConex).apply().get()));
        /////////////////////////////////////////////////////////////////////////
        ...
        System.out.println("El grafo conexo es un ciclo Euleriano ?: " + (new EulerianCycleDetection<>(graphConexOdd).
                                                                          apply().get()));
    }
}
